        ...
        <div className="bg-(--card-bg) rounded-[2rem] lg:rounded-[2.5rem] border border-(--border) p-8 md:p-12 lg:p-16 grid grid-cols-1 lg:grid-cols-12 gap-16 mb-12">
          ...
          <div className="lg:col-span-5 space-y-8 text-center lg:text-left">
            ...
            <div className="flex justify-center lg:justify-start gap-6">
              <a href="#" className="w-10 h-10 rounded-full bg-(--background) border border-(--border) flex items-center justify-center text-(--zinc-muted) hover:text-(--accent-primary) hover:border-(--accent-primary) transition-all premium-card-shadow">
